...
export const DUNGEON_MOBS: Record<string, MobTemplate> = {
  ...
  crypt_shambler: {
    id: 'crypt_shambler', name: 'Mahzen Sürüngeni', minLevel: 7, maxLevel: 8, family: 'undead', elite: true,
  ...
  hollow_acolyte: {
    id: 'hollow_acolyte', name: 'Oyuk Müridi', minLevel: 8, maxLevel: 8, family: 'undead', elite: true,
  ...
  bonechill_widow: {
    id: 'bonechill_widow', name: 'Kemiküşüten Dul', minLevel: 8, maxLevel: 9, family: 'spider', elite: true,
  ...
  sexton_marrow: {
    id: 'sexton_marrow', name: 'Zangoç Marrow', minLevel: 9, maxLevel: 9, family: 'undead', elite: true,
  ...
  morthen: {
    id: 'morthen', name: 'Mezarçağıran Morthen', minLevel: 10, maxLevel: 10, family: 'undead',
    ...
    aoePulse: { min: 12, max: 18, radius: 12, every: 10, name: 'Gölge Dalgası' },
  ...
  bastion_revenant: {
    id: 'bastion_revenant', name: 'Burç Hortlağı', minLevel: 12, maxLevel: 13, family: 'undead', elite: true,
  ...
  tidebound_acolyte: {
    id: 'tidebound_acolyte', name: 'Dalgabağlı Mürit', minLevel: 12, maxLevel: 13, family: 'humanoid', elite: true,
  ...
  drowned_thrall: {
    id: 'drowned_thrall', name: 'Boğulmuş Köle', minLevel: 11, maxLevel: 11, family: 'undead',
  ...
  knight_commander_olen: {
    id: 'knight_commander_olen', name: 'Şövalye Kumandan Olen', minLevel: 13, maxLevel: 13, family: 'undead', elite: true,
    hpBase: 120, hpPerLevel: 26, dmgBase: 11, dmgPerLevel: 2.6, attackSpeed: 2.2,
    armorPerLevel: 24, moveSpeed: 7, aggroRadius: 14,
    loot: [{ copper: 800, chance: 1 }], // his greaves are Zeynep's quest reward, not a drop
    scale: 1.2, color: 0x95a5a6,
  },
  vael_the_mistcaller: {
    id: 'vael_the_mistcaller', name: 'Sisçağıran Vael', minLevel: 13, maxLevel: 13, family: 'humanoid',
    elite: true, boss: true,
    hpBase: 240, hpPerLevel: 34, dmgBase: 12, dmgPerLevel: 2.6, attackSpeed: 2.4,
    armorPerLevel: 26, moveSpeed: 7, aggroRadius: 16,
    aoePulse: { min: 16, max: 24, radius: 12, every: 10, name: 'Sis Dalgası' },
  ...
  sanctum_boneguard: {
    id: 'sanctum_boneguard', name: 'Tapınak Kemik Muhafızı', minLevel: 19, maxLevel: 19, family: 'undead', elite: true,
  ...
  sanctum_drakonid: {
    id: 'sanctum_drakonid', name: 'Tapınak Drakonidi', minLevel: 19, maxLevel: 20, family: 'dragonkin', elite: true,
  ...
  raised_bonewalker: {
    id: 'raised_bonewalker', name: 'Diriltilmiş Kemikgezer', minLevel: 18, maxLevel: 18, family: 'undead',
  ...
  korgath_the_bound: {
    id: 'korgath_the_bound', name: 'Zincirli Korgath', minLevel: 20, maxLevel: 20, family: 'ogre', elite: true,
  ...
  grand_necromancer_velkhar: {
    id: 'grand_necromancer_velkhar', name: 'Baş Nekromant Velkhar', minLevel: 20, maxLevel: 20, family: 'humanoid', elite: true,
  ...
  korzul_the_gravewyrm: {
    id: 'korzul_the_gravewyrm', name: 'Mezarejderi Korzul', minLevel: 20, maxLevel: 20, family: 'dragonkin',
    elite: true, boss: true,
    hpBase: 420, hpPerLevel: 48, dmgBase: 15, dmgPerLevel: 3.0, attackSpeed: 2.6,
    armorPerLevel: 34, moveSpeed: 7, aggroRadius: 18,
    aoePulse: { min: 30, max: 42, radius: 14, every: 8, name: 'Nekrotik Şok Dalgası' },
    enrage: { belowHpPct: 0.30, dmgMult: 1.5 },
    loot: [
...
export const DUNGEON_DEFS: Record<string, DungeonDef> = {
  hollow_crypt: {
    ...
    interior: 'crypt',
    suggestedPlayers: 5,
    enterText: 'Oyuk Mahzen\'e iniyorsun...',
    leaveText: 'Gün ışığına geri tırmanıyorsun.',
  },
  sunken_bastion: {
    id: 'sunken_bastion',
    name: 'Batık Burç',
    ...
    interior: 'crypt',
    suggestedPlayers: 5,
    enterText: 'Batık Burç\'a doğru suda ilerliyorsun...',
    leaveText: 'Boğucu karanlıktan dışarı tırmanıyorsun.',
  },
  gravewyrm_sanctum: {
    id: 'gravewyrm_sanctum',
    name: 'Mezarejderi Tapınağı',
    index: 2,
    ...
    leaveText: 'Sendeleyerek dağ rüzgârına geri çıkıyorsun.',
  },
};
