...
![AnadoluCraft title screen](docs/screenshots/title-screen.jpg)

AnadoluCraft, Kurudere Bozkırı'nda geçen web tabanlı bir micro-MMO oyunudur.
Tek kişilik çevrim dışı modla hızlıca denenebilir veya sunucu/Postgres
kurulumu ile çok oyunculu olarak oynanabilir.

- Kaynak kod: [https://github.com/AnubisZk/kurudere-craft](https://github.com/AnubisZk/kurudere-craft)
- Netlify: [https://anadolucraft-kurudere.netlify.app/](https://anadolucraft-kurudere.netlify.app/)
...
![A party gathers outside the apothecary in Kurudere](docs/screenshots/party-questing.jpg)

| | |
|:---:|:---:|
| ![Dusk at the Kurudere campfire](docs/screenshots/eastbrook-dusk.jpg)<br>*Dusk at the Kurudere campfire* | ![Elite pulls in the Hollow Crypt](docs/screenshots/hollow-crypt.jpg)<br>*Torch-lit elite pulls in the Hollow Crypt* |
...
![AnadoluCraft](worldofclaude.png)

![AnadoluCraft community](woc_community.png)
...
Name your character, pick any of the nine classes, and you're in **Kurudere
Bozkırı** (levels 1-7): a caravan inn ringed by six hubs — wolf runs north, dry
meadows east, the scorpion rocks west, the Silent Well northwest, a kobold copper dig
southwest, an old spring with restless dead northeast, and Gorrak's dusty road
...
conspiracy, from the first restless bones outside Kurudere to **Korzul the
